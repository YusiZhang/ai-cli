...
class StreamingDisplay:
    ...
    def __init__(self, console: Console):
        ...
        self.live_display: Live = None
        self.model_name = ""
    
    async def update_response(self, response: str, model_name: str = ""):
...
class MultiStreamDisplay:
    ...
    async def update_model_response(self, model_name: str, response: str):
    ...
    async def finalize_all_responses(self):
    ...
    def _create_multi_display_content(self):
        ...
        for i, (model_name, response) in enumerate(self.model_responses.items()):
            ...
            if not response.strip():
                content = Text("🤔 Thinking...", style="dim")
            else:
        ...
        return Columns(panels, equal=True) if panels else Text("Waiting for responses...")